...
@section('content')
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow mb-6">
            <div
                class="p-4 sm:p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="flex items-center gap-3 sm:gap-4">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                        <i class="fas fa-user text-blue-600 text-xl sm:text-2xl"></i>
                    </div>
                    <div class="min-w-0">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-900 break-words">{{ $customer->name }}</h2>
                        <p class="text-xs sm:text-sm text-gray-500">Detail Pelanggan</p>
                    </div>
                </div>
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                    <a href="{{ route('customers.edit', $customer) }}"
                        class="flex-1 sm:flex-none bg-yellow-500 text-white px-4 sm:px-5 py-2.5 rounded-lg hover:bg-yellow-600 transition text-sm font-medium inline-flex items-center justify-center gap-2">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="{{ route('orders.create') }}?customer_id={{ $customer->id }}"
                        class="flex-1 sm:flex-none bg-green-600 text-white px-4 sm:px-5 py-2.5 rounded-lg hover:bg-green-700 transition text-sm font-medium inline-flex items-center justify-center gap-2">
            ...
            <div class="p-4 sm:p-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 break-words">{{ $customer->name }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 min-w-0">
                                    <div
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 break-words">{{ $customer->phone }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 min-w-0">
                                    <div
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 break-words">{{ $customer->whatsapp ?? '-' }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 min-w-0">
                                    <div
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 break-words">{{ $customer->email ?? '-' }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 md:col-span-2 min-w-0">
                                    <div
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 break-words">{{ $customer->address ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 sm:p-5">
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 sm:p-5">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-lg font-bold text-green-900 break-words">Rp
                ...
                <div class="mt-6 sm:mt-8">
                                        ...
                                        <tbody>
                                            @foreach($customer->orders as $order)
                                                <tr class="border-b border-gray-200 hover:bg-white transition">
                                                    <td class="py-3 px-4 font-medium text-gray-900 text-sm">{{ $order->order_number }}</td>
                                                    <td class="py-3 px-4 text-gray-600 text-sm">{{ $order->order_date->format('d/m/Y') }}</td>
                                                    <td class="py-3 px-4 font-semibold text-gray-900 text-sm">Rp
                    ...
                    @else
                        <div class="bg-gray-50 rounded-xl p-6 sm:p-8 text-center">
                            <div class="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 bg-gray-200 rounded-full flex items-center justify-center">
